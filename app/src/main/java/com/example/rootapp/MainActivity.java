...
public class MainActivity extends AppCompatActivity {
        AppCompatButton and_btn,ios_btn,full_btn;
        ImageView and_img,ios_img,full_img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
         ...
         and_btn=findViewById(R.id.android_button);
        ios_btn=findViewById(R.id.ios_button);
         full_btn=findViewById(R.id.fulStack_button);
         and_img=findViewById(R.id.android_img);
         ios_img=findViewById(R.id.ios_img);
         full_img=findViewById(R.id.fullStack_img);
    }

    public void onClick(View view){
        if (view.getId()==R.id.android_img){
        ...
        if (view.getId()==R.id.android_button){
            Intent intent=new Intent(this,Result_Activity.class);
            intent.putExtra("course", "\n" +
                    "content Adroid  >>>>>\n" +
                    "Part 1 ( Java SE)\n" +
...
/////////////////////////////////////////////////////////////////////////
        ...
        if (view.getId()==R.id.fullStack_img){
            Intent intent=new Intent(this,Result_Activity.class);
            intent.putExtra("course", "\n" +
                    "Content Full Stack >>>>>\n" +
                    "\n" +
        ...
        if (view.getId()==R.id.fulStack_button){
            Intent intent=new Intent(this,Result_Activity.class);
            intent.putExtra("course","\n" +
                    "Content Full Stack >>>>>\n" +
                    "\n" +
...
//    public void onClick(View view){
//        if (view instanceof AppCompatButton ||view instanceof ImageView){
//            assert view instanceof AppCompatButton;
//            AppCompatButton appCompatButton=(AppCompatButton) view;
//            ImageView imageView =(ImageView) view;
//             if (view.getId()==R.id.android_button||view.getId()==R.id.android_img) {
